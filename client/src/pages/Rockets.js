      ...
      <div class="rocketContainer">
        ...
        <section id="rocket-selection" class="rocket">
          <div className="rocket-img-box">
            <img alt='' src={rocketImage1} class="float-left"
            ></img>
          </div>
          <h2>Sonic Rocket</h2>
          <p>
        ...
        <section id="superRocket-selection" class="rocket">
          <div className="rocket-img-box">
            <img alt='' src={rocketImage2} class="float-left"
            ></img>
          </div>
        ...
        <section id="superRocket-selection" class="rocket">
          <div className="rocket-img-box">
            <img alt='' src={rocketImage3} class="float-left"
            ></img>
          </div>
          <h2>Apollo 999</h2>
        ...
        <section id="superRocket-selection" class="rocket">
          <div className="rocket-img-box">
            <img alt='' src={rocketImage4} class="float-left"
            ></img>
          </div>
          <h2>SpaceJet </h2>
